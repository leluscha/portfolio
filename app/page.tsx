...
export default function Page() {
  ...
  return (
    <main className="site-shell">
      ...
      <section id="about" className="white-section about-section"><div><h2>Good products begin with<br /><strong>better questions.</strong></h2><p>With a foundation in sound engineering and experience across product operations, talent, and growth, I bring a systems mindset to ambiguous problems. I listen closely, map what matters, and turn signals into clear action.</p><div className="about-meta"><span>Product strategy</span><span>UX &amp; workflows</span><span>Cross-functional leadership</span></div></div></section>
